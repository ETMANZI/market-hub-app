...
# ============================================
# This section runs migrations when connected to Railway database
# Set DATABASE_URL environment variable to run migrations against Railway
...
if os.environ.get("DATABASE_URL"):
    ...
    try:
        # Check if this is a migration command or normal run
        import sys
        if 'migrate' not in sys.argv:
            call_command('migrate', interactive=False)
            print("✅ Migrations completed successfully")
        else:
            print("⏳ Running migrations via command...")
